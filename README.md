...
- **Tool approval** - configurable trust levels per task: supervised, auto-safe, or full auto. The auto-safe policy is itself customizable in Settings (read/write scope, web search, web fetch domains, MCP servers, Bash deny patterns) globally and per project
