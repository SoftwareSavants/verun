//! Developer-instructions strings passed as `collaborationMode.settings.developer_instructions`
//! on Codex `turn/start`. Ported verbatim from t3code:
//!
//!   competitors/t3code/apps/server/src/provider/CodexDeveloperInstructions.ts
//!
