...
- Refresh Claude and Codex model options: Claude picker leads with the Claude 5 family (`claude-opus-5` default, plus `claude-fable-5`, `claude-sonnet-5`, previous-gen `claude-opus-4-8`, `claude-haiku-4-5`); Codex leads with GPT-5.6 (`gpt-5.6-sol` default, plus `gpt-5.6-terra`, `gpt-5.6-luna`, and recent `gpt-5.5`/`gpt-5.4`/`gpt-5.4-mini`/`gpt-5.3-codex`). Codex turn default also bumped to `gpt-5.6-sol`
