...
- Codex chat now auto-loads older history when the first page does not create a scrollbar, so long sessions no longer get stuck showing only the last few visible turns until you resize the window
