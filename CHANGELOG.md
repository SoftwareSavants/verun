...
- Claude model picker now includes `claude-opus-4-8` as the top Opus option
- Codex model picker/default now tracks the current GPT-5.5-era coding models: `gpt-5.5`, `gpt-5.5-pro`, `gpt-5.4`, `gpt-5.4-pro`, `gpt-5.4-mini`, `gpt-5.4-nano`, `gpt-5.3-codex`; new Codex sessions now default to `gpt-5.5`
